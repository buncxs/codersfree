<header class="bg-neutral-700 sticky top-0 z-50" x-data="dropdown()">
    ...
    <nav id="navigation-menu" 
        x-cloak x-show="open"
        class="bg-neutral-700 bg-opacity-25 absolute w-full">
        <!-- Menu Desktop -->
        ...
        <div class="bg-white h-f overflow-y-auto md:hidden">
            ...
            @auth
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button class="py-2 px-4 text-sm flex items-center w-full text-neutral-500 hover:bg-orange-500 hover:text-white">
                        <span class="flex justify-center w-9">
